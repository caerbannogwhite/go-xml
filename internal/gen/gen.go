...
func FormattedSource(file *ast.File, output string) ([]byte, error) {
	...
	generatedByComment := "// Code generated by the Go XSD Generator. DO NOT EDIT.\n"
	generatedByComment += "// However, if you really need to change it, please check\n"
	generatedByComment += "// https://github.com/droyo/go-xml or http://git.quantics.local/QuBAS/go-xsd-generator\n\n"
